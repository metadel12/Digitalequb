...
Scenario:
- 4 members: 3 paid 100 birr each, 1 paid 50 birr
- Expected originally: 400, Collected: 350, Shortfall: 50
- Add 1 member to pay 50 birr (shortfall amount)
- After: 5 members total, but expected should be 450 (not 500)
- Collected: 400, Expected: 450? No! Expected should be 400!
- 3×100 + 1×50 + 1×50 = 400 ✅

The fix: Expected amount = sum of what each member should actually pay
"""
...
def test_shortfall_calculation():
    ...
    for member in group_members:
        if member.get("is_shortfall_member") and member.get("auto_verified"):
            ...
            # For regular members, expect full contribution
